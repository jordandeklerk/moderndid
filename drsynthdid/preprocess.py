...
def _check_treatment_uniqueness(df: pd.DataFrame, id_col: str, treat_col: str) -> None:
    ...
    ----------
    df : pd.DataFrame
        The input DataFrame, expected to contain panel data.
    id_col : str
        The name of the column identifying units.
    treat_col : str
        The name of the column identifying treatment status. This column's values
        should be constant within each unit for panel data.
    """
...
def _make_balanced_panel(df: pd.DataFrame, id_col: str, time_col: str) -> pd.DataFrame:
    ...
    ----------
    df : pd.DataFrame
        The input DataFrame, potentially unbalanced panel data.
    id_col : str
        The name of the column identifying units.
    time_col : str
    ...
    -------
    pd.DataFrame
        A DataFrame containing only the units that form a balanced panel.
