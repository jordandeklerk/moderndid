...
DDD_BENCHMARK_SUITES: dict[str, list[DDDBenchmarkConfig]] = {
    "scaling_units_2period": [
        ...
        DDDBenchmarkConfig(n_units=2000, multi_period=False),
        DDDBenchmarkConfig(n_units=4000, multi_period=False),
        DDDBenchmarkConfig(n_units=5000, multi_period=False),
        DDDBenchmarkConfig(n_units=10000, multi_period=False),
        DDDBenchmarkConfig(n_units=20000, multi_period=False),
        DDDBenchmarkConfig(n_units=50000, multi_period=False),
        DDDBenchmarkConfig(n_units=100000, multi_period=False),
        DDDBenchmarkConfig(n_units=200000, multi_period=False),
        DDDBenchmarkConfig(n_units=500000, multi_period=False),
        DDDBenchmarkConfig(n_units=1000000, multi_period=False),
        DDDBenchmarkConfig(n_units=2000000, multi_period=False),
        DDDBenchmarkConfig(n_units=5000000, multi_period=False),
        DDDBenchmarkConfig(n_units=10000000, multi_period=False),
    ],
