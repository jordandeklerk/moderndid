"""CLI entry point for running att_gt benchmarks."""
...
def run_single_benchmark(
    ...
    python_runner: ATTgtPythonRunner,
    r_runner: ATTgtRRunner | None,
...
def run_benchmark_suite(
    ...
    python_runner = ATTgtPythonRunner()
    r_runner = None if python_only else (ATTgtRRunner() if R_DID_AVAILABLE else None)
