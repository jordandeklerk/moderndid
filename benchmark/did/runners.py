"""Benchmark runners for att_gt (Python) vs did (R) package."""
...
class ATTgtPythonRunner(BaseBenchmarkRunner):
...
class ATTgtRRunner(BaseBenchmarkRunner):
    """Benchmark runner for R did package att_gt implementation."""

    def __init__(self):
        self._r_available = R_DID_AVAILABLE
