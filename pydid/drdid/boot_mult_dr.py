...
def mboot_did(
    ...
    This function takes the influence function (linear representation) and
    applies bootstrap weights to compute bootstrap estimates.

    Parameters
    ----------
    linrep : np.ndarray
        Influence function (linear representation) of shape (n_units,).
