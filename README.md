<img src="docs/source/_static/pydid-light.png#gh-light-mode-only" width="250" align="left" alt="pyDiD logo"></img>
...
__pyDiD__ is a Python package implementing modern DiD estimators, including staggered treatment timing, multiple time periods, doubly robust methods, machine learning approaches, and diagnostic tools like the Bacon-Goodman decomposition and sensitivity tests for functional form.
