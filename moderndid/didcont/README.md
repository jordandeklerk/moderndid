...
The examples below use the bundled test data (`tests/didcont/data`). These datasets are generated by the helper `simulate_contdid_data` in [`tests/didcont/dgp.py`](tests/didcont/dgp.py):
