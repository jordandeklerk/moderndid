...
from causaldid.drdid import std_ipw_did_rc
...
def test_std_ipw_did_rc_bootstrap_weighted():
    ...
    result = std_ipw_did_rc(y=y, post=post, d=d, covariates=x, boot=True, boot_type="weighted", nboot=50)
...
def test_std_ipw_did_rc_bootstrap_multiplier():
    ...
    result = std_ipw_did_rc(y=y, post=post, d=d, covariates=x, boot=True, boot_type="multiplier", nboot=50)
...
def test_std_ipw_did_rc_args_output():
    ...
    result = std_ipw_did_rc(y=y, post=post, d=d, covariates=x, boot=True, nboot=50, trim_level=0.99)
