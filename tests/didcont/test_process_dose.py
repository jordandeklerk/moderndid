...
def test_multiplier_bootstrap_dose_different_alpha():
    ...
    result_05 = _multiplier_bootstrap_dose(influence_function, biters=100, alpha=0.05)
    result_10 = _multiplier_bootstrap_dose(influence_function, biters=100, alpha=0.10)
